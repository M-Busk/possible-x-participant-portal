...
import eu.possible_x.backend.business.entity.edc.asset.ionoss3extension.IonosS3DataDestination;
...
import eu.possible_x.backend.business.entity.edc.negotiation.ContractOffer;
...
public class ConsumerService {
    ...
    public IonosS3DataAddress acceptContractOffer(ConsumeOfferRequestTO request) {
        ...
        CatalogRequest catalogRequest = CatalogRequest.builder().counterPartyAddress(request.getCounterPartyAddress())
            .build();
        ...
        NegotiationInitiateRequest negotiationInitiateRequest = NegotiationInitiateRequest.builder()
            .counterPartyAddress(request.getCounterPartyAddress()).providerId(catalog.getParticipantId()).offer(
        ...
        TransferRequest transferRequest = TransferRequest.builder().connectorId(catalog.getParticipantId())
